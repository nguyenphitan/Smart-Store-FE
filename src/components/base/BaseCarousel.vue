...
export default {
    ...
    props: {
        ...
        carouselDescription: {
            type: String,
            default: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quis lobortis consequat eu, quam etiam at quis ut convallis.'
        }
    },
    components: {
        BaseButton,
...
<style scoped>
@import url('../../styles/base/carousel.css');
</style>