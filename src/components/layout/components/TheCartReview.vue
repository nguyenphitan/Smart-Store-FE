<template>
    <div id="the-cart-review">
        <!-- Container -->
        <div id="cart-review-container">
            <h4 style="font-weight: bold;" class="t-flex t-align-center">
                <svg style="margin-right: 10px;" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" class="injected-svg" data-src="/assets/images/icons/bag_filled.svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
<style>
@import url('../../../styles/layout/orderReview.css');
</style>